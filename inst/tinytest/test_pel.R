...
## reversability
px <- ppel(x,a,v,theta)
xx <- qpel(px,a,v,theta)
e <- (xx-x)
range(e) ## this isn't great exp in the upper tail - is it down to lamW function, seems more significant on tails??

px <- ppel(x,a,v,theta,lower.tail=F)
xx <- qpel(px,a,v,theta,lower.tail=F)
e <- (xx-x)
range(e) ## this isn't great exp in the upper tail - is it down to lamW function, seems more significant on tails??

px <- ppel(x,a,v,theta,lower.tail=F,log.p=T)
xx <- qpel(px,a,v,theta,lower.tail=F,log.p=T)
e <- (xx-x)
range(e) ## this isn't great exp in the upper tail - is it down to lamW function, seems more significant on tails??

px <- ppel(x,a,v,theta,log.p=T)
xx <- qpel(px,a,v,theta,log.p=T)
e <- (xx-x)
range(e) ## this isn't great exp in the upper tail - is it down to lamW function, seems more significant on tails??
